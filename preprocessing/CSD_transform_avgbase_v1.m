...
for s=1:length(subject_list)
    ...
    for trltype = 1:size(trial_type,2)
        ...
        EEG=pop_loadset('filename',[subject '_Referenced_Epoched_'  trial_type{trltype} '.set'], 'filepath', Epoched_Data);
        ...
        EEG = pop_editset(EEG, 'setname', [subject '_Referenced_Epoched_CSD_' trial_type{trltype}]);
        EEG = pop_saveset( EEG, 'filename',[subject '_Referenced_Epoched_CSD_' trial_type{trltype} '.set'],'filepath', CSD_avgbase);
